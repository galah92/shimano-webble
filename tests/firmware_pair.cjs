...
(async()=>{
 ...
 for(const change of [o=>o.files=[file(d),file(d)],o=>o.files=[file(d),file(new Uint8Array(256))],o=>o.baseline.family=35,o=>delete o.baseline.destination,o=>delete o.identityReference,o=>o.identityReference.verified=false,o=>delete o.identityReference.bootloaderIdentity,o=>o.identityReference.expected.identity='c'.repeat(64),o=>o.identityReference.salt='bad',o=>o.credentials=new Uint8Array(14),o=>delete o.characteristics['2afe']]){

# Archived build diary (superseded)

This is the former README, preserved for historical context. Its build notes
are not a current procedure. Start with [HANDOFF.md](../HANDOFF.md) and
[ASSETS.md](../ASSETS.md) for the validated state and artifact policy.
